      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            {/* Mobile Menu Button */}
            <button
              className="md:hidden text-white p-2 transition-transform duration-300 hover:scale-110 active:scale-95 z-50"
        ...
        {isMenuOpen && (
          <motion.div
            className="md:hidden fixed inset-0 bg-primary-900 z-40 mobile-menu-container overflow-auto"
